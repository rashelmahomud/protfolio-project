const Util = () => {
  return (
    <div className="lg:flex items-center flex-col p-10 mx-auto hidden">
      <div className="my-2">
          <p className="w-5 h-6 border-2 border-teal-300 rounded-full relative -ml-1"></p>
          <p className="w-1 h-2 border-2 border-teal-300 rounded-full absolute -mt-3 ml-1"></p>
      </div>
